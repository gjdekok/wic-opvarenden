...
def deed_list(request):
    if request.method == 'POST':
        ...
        order_column = ['id', 'deed_date', 'final_name', 'final_location', 'final_ship_name', 'final_role', 'final_organization', 'final_captain'][order_column]
        ...
        data = list(query_set.values('id', 'deed_date', 'final_name', 'final_location', 'final_ship_name', 'final_role', 'final_organization', 'final_captain'))  # added final_captain
